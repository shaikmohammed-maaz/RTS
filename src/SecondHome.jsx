    ...
    <div id="home">
      ...
      <div className="container-fluid text-dark position-relative p-0">
        ...
        >
          ...
          >
            <h1 className=" home-bg-img-head">
              Welcome to Redmond Tamil School
            </h1>
            <p className="home-bg-img-text">
              At Redmond Tamil School, we nurture students with Tamil heritage,
              fostering cultural pride and empowering them with knowledge for a
              bright future.
            </p>
          </div>
        </div>
      ...
      <div className="container d-flex flex-column align-items-center justify-content-center text-dark mb-2">
        <div className="about-content m-5 d-flex flex-column align-items-center justify-content-center text-dark">
          <h3
            style={{ fontWeight: "bold", marginBottom: "3%", marginTop: "-4%" }}
          >
            About Us
          </h3>
          <p>
            vestibulum non volutpat porttitor sit. Dolor amet at in facilisis in
            pulvinar lectus ut diam. Pharetra laoreet lobortis ut vivamus
            placerat vitae non feugiat. Pharetra mauris in quam non vitae. Amet
            habitant pretium nascetur nunc pretium. I incidunt et nec quis amet
            et id volutpat. sed vestibulum non risus nulla Risus sit senectus a
            velit. Vestibulum euismod eget vestibulum eget elementum duis nibh
            odio quisque. Cras taucibus viverra aenean commodo egestas posuere
            tincidun tortor. Molestie viverra vitae lacinia in venenatis in
            pellentesque. Lobortis ipsum ipsum condimentum in aliquam commodo
            molestie. Elementum nullam massa tortor ut amet felis fringilla
            lacus aliquam. Eget nibh tempus volutpat sociis risus. Lacus
            faucibus massa in amet. Eget ultrices curabitur felis malesuada ante
            arcu egestas. Donec.
          </p>

          <Link className="web-color mt-4" to={"/About-us"}>
            Know More
          </Link>
...
function CardWithContentDetails({
  link,
  spanVal,
  heading,
  checkTrue,
  ...
  return (
    <>
      <div className={`${checkTrue ? "left-align" : "right-alignment"} mb-3`}>
        <Link className="web-color" to={"/Blog"}>
            <b>{link}</b>
          </Link>
      </div>
      <h2
        className={`${
          checkTrue ? "left-align" : "right-alignment"
        } mb-3 span-val`}
      >
        <b>
  ...
  return (
    <div className="image-container">
      <img
        src={imagePathLink}
        alt=""
        className="home-colum-image"
        style={
          isTabView
            ? { width: "69%", height: "auto" }
            : { width: "69%", height: "auto", marginLeft: "19%" }
        }
      />
    </div>
  );
